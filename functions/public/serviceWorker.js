...
****
                    ServiceWorker(sw.js)
UTILIZZATA PER LA REALIZZAZIONE DELLA PWA NON TOCCARE ! ****
UTILIZZABILE ANCHE PER CREARE L'APP IN LOCALE USANDO LE CACHE ( DA VEDERE ) 
**** 
*/
...
/* console.log("Applicazione installabile sui dispositivi!"); */
    ...
    e.waitUntil(
        caches.open(nameCacheStorage).then(cache =>{
            ...
            return cache.addAll(["./", "./PWAsrc/master.css","./images/icon/logo192.png"]);
        })
    )
});
